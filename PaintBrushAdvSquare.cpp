...
PaintBrushAdvSquare::PaintBrushAdvSquare(void)
{
}
...
void PaintBrushAdvSquare::Paint(CPoint &ptStart, CPoint &ptEnd, MemoryImage *pCanvas, CDC *pDC)
{
	...
	pDC->Rectangle(sx-m_bsize2, sy-m_bsize2, sx+m_bsize2, sy+m_bsize2);
	pDC->Rectangle(ex-m_bsize2, ey-m_bsize2, ex+m_bsize2, ey+m_bsize2);
